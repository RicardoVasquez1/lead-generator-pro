...
export declare const LOG_SCOPES: readonly ["concurrency", "external-secrets", "license", "multi-main-setup", "pruning", "pubsub", "push", "redis", "scaling", "waiting-executions", "task-runner", "insights", "workflow-activation", "ssh-client", "cron", "community-nodes", "legacy-sqlite-execution-recovery"];
