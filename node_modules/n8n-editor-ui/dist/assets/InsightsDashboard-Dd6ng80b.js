const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-CMRBFk7F.js","assets/index-eiGMGof4.js","assets/index-BFyMw9-0.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-DD_g0FlT.js","assets/chartjs.utils-ziIypBRK.js","assets/InsightsSummary-od7C9keP.js","assets/InsightsSummary-DTFIhBF3.css","assets/index-D4wn1X5v.js","assets/InsightsChartFailed-e8gNXvOD.js","assets/InsightsChartFailureRate-CTHQ0RyF.js","assets/InsightsChartTimeSaved-DnvNXWyi.js","assets/InsightsChartAverageRuntime-PuDIJUWO.js","assets/InsightsTableWorkflows-bDP7Feik.js","assets/InsightsTableWorkflows-BTHSCwX8.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, eg as useModel, g6 as useInsightsStore, r as ref, gD as UNLICENSED_TIME_RANGE, gf as TIME_RANGE_LABELS, e as createBlock, g as openBlock, w as withCtx, h as createElementBlock, F as Fragment, A as renderList, l as unref, e9 as _sfc_main$3, k as createTextVNode, f as createCommentVNode, t as toDisplayString, j as createBaseVNode, e8 as N8nSelect, x as computed, c as useI18n, i as createVNode, p as N8nText, q as N8nButton, gE as ElDialog, aB as usePageRedirectionHelper, _ as _export_sfc, aa as useRoute, gF as INSIGHT_TYPES, du as defineAsyncComponent, af as watch, o as onMounted, ay as useDocumentTitle, m as N8nHeading, n as normalizeClass, dJ as _sfc_main$4, ca as resolveDynamicComponent, aW as __vitePreload, ap as useTelemetry, gG as TELEMETRY_TIME_RANGE } from "./index-eiGMGof4.js";
import { I as InsightsSummary } from "./InsightsSummary-od7C9keP.js";
const _hoisted_1$2 = {
  key: 0,
  width: "16",
  height: "17",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-CMRBFk7F.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-DD_g0FlT.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-e8gNXvOD.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-CTHQ0RyF.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-DnvNXWyi.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-PuDIJUWO.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-bDP7Feik.js"), true ? __vite__mapDeps([13,1,2,6,7,14]) : void 0)
    );
    const props = __props;
